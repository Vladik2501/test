...
// 4 Використовуючи данні з масиву, за допомоги document.write та циклу
...
//     },
// ];
// document.write(`<div style="width: 300px;height: 200px;box-sizing: border-box" class="product-card">`)
// for (let product of products) {
//     document.write(`<h3>${product.title}</h3>`)
//     document.write(`<h4>${product.price}</h4>`)
//     document.write(`<img src="${product.image}" alt="test">`)
// }
// document.write(`</div>`)
...
// }
for (let user of users) {
    if(user.age > 28 && user.status === true){
        console.log(user)
    }
}
